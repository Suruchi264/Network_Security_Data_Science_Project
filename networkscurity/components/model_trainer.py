...
import dagshub
#dagshub.init(repo_owner='krishnaik06', repo_name='networkscurity', mlflow=True)

os.environ["MLFLOW_TRACKING_URI"]="https://dagshub.com/krishnaik06/networkscurity.mlflow"
...
class ModelTrainer:
    ...
    def track_mlflow(self,best_model,classificationmetric):
        mlflow.set_registry_uri("https://dagshub.com/krishnaik06/networkscurity.mlflow")
